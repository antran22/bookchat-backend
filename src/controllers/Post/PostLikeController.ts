import {Delete, Get, Path, Put, Query, Request, Route, Security, Tags,} from "@tsoa/runtime";
import {PostLikeJSON, PostModel} from "@/models/Post";
import type express from "express";
import {env, getLastID, ModelNotFoundException, NotFoundException,} from "@/utils";
import type {DeleteResult, Listing} from "../_ControllerUtils";
import {listLikeFromPost, makeUserLikePost, makeUserUnlikePost,} from "@/services/Post";
